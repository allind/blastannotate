...
#filter junctions
python /pollard/data/projects/alind/protist_sequencing/Blastocystis_BT1/bt1_lib1/assembly/blastannotate/scripts/filter_sj_tabfile.py $prefix"_firstpass_SJ.out.tab" 3 > $prefix"_firstpass_min5_SJ.out.tab"
